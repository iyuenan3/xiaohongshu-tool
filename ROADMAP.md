...
> 路线图 v0.2 · 2026-05-16 · 配套 PRD v0.3 + SPEC v0.1
...
PRD §10 的 D1-D5 需要在不同 milestone 前敲定（v0.3 后 D4 截止时间放宽，因为不需要 Apple Developer 主体）：

| 决策 | 议题 | 截止节点 | 不决定的后果 |
|---|---|---|---|
| **D1** | 售价区间 | W7 结束前 | 阻塞激活码发放话术 |
| **D2** | 是否试用版 | W6 开始前 | 影响 Worker 接口设计（是否要 trial flag） |
| **D3** | 产品名 + 域名 | W10 开始前 | 官网无法定稿 |
| **D4** | 法律主体 | W10 开始前 | 用户协议落款（v0.3 后不再阻塞 Apple Developer 注册） |
| **D5** | 支持渠道 | W10 结束前 | 阻塞客服 SOP 起草 |
