...
> 版本 v0.3 · 2026-05-16 · 路线 A（完全本地化 + BYOK + 无证书发布）
...
|---|---|
| 模式 | **一次性买断** |
| 价格 | 待定（建议 ¥199 - ¥499，需市场验证） |
| 含更新 | 1 年内更新免费，1 年后买更新订阅（V2 决定） |
| 收款 | MVP 手动收款（微信/支付宝转账），盈利后接虎皮椒聚合支付 |
...
| 编号 | 议题 | 影响 |
|---|---|---|
| D1 | 售价区间（¥199 / ¥299 / ¥499） | 影响销售模式与目标用户 |
| D2 | 是否提供试用版 | 影响转化漏斗 |
| D3 | 产品全名（中英文）+ 域名（如要做官网） | 影响品牌 |
| D4 | 法律主体（个人 / 个体工商户 / 公司） | 影响开票、合规、责任 |
| D5 | 支持渠道（微信群 / 邮件 / GitHub Issues） | 影响客服压力 |
